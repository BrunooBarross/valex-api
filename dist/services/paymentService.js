...
export function makePayment(cardId, password, businessId, amount) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    _a.sent();
                    return [4 /*yield*/, verifyAndValidateBusiness(businessId, card.type)];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, verifyCreditAmount(cardId, amount)];
                case 6:
                    _a.sent();
                    paymentRepository.insert({ cardId: cardId, businessId: businessId, amount: amount });
                    return [2 /*return*/];
            }
        });
    });
}
function verifyAndValidateBusiness(businessId, cardType) {
    return __awaiter(this, void 0, void 0, function () {
        var business;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, businessReposiroty.findById(businessId)];
                case 1:
                    business = _a.sent();
                    if (!business) {
...
function verifyCreditAmount(cardId, amount) {
    return __awaiter(this, void 0, void 0, function () {
